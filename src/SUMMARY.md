...
* [Logging, Notifications and Status](logging-notifications-status/README.md)
  * [Logging](logging-notifications-status/logging.md)
  * [Reporting Job Progress](logging-notifications-status/reporting-job-progress.md)
  * [Sending Slack Notifications](logging-notifications-status/sending-slack-notifications.md)
* [Configuration](configuration/README.md)
  * [Jobly Configuration](configuration/jobly-config.md)
  * [Worker Configuration](configuration/worker-config.md)
  * [Custom Settings](configuration/custom-settings.md)
  * [Workspace Info](configuration/workspace-info.md)
